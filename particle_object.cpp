...
void particle_object::create(GLuint program)
{
	...
	//Own STB implementation
	int width, height, nrChannels;

	unsigned char* data_texture = stbi_load("..\\..\\images\\circle.png", &width, &height, &nrChannels, 0);
	...
	if (data_texture) {
		...
		glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, pixelFormat, GL_UNSIGNED_BYTE, data_texture);
		...
		printf("I have suicidal thoughts, this year is killing me");
		//exit(0);
	}
...
void particle_object::drawParticles(glm::mat4 ProjectionMatrix, glm::mat4 ViewMatrix)
{
	...
	if (newparticles > (int)(0.016f*700.0))
		newparticles = (int)(0.016f*700.0);
